...
The repository now includes a GitHub Actions workflow that publishes the static files whenever you push to `main`.
...
4. Save. The bundled `Deploy static site to GitHub Pages` workflow will upload the site on each push to `main` and display the public URL once the deployment finishes.
